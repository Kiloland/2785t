...
{
    // VGA_DDC
    MCU_FF1D_ADC_DDC_CONTROL_2 = (usISPChannel & _BIT0) ? (MCU_FF1D_ADC_DDC_CONTROL_2 | _BIT3) : (MCU_FF1D_ADC_DDC_CONTROL_2 & (~_BIT3));
    // DDC0
    MCU_FF20_DDC0_DDC_CONTROL_2 = (usISPChannel & _BIT1) ? (MCU_FF20_DDC0_DDC_CONTROL_2 | _BIT3) : (MCU_FF20_DDC0_DDC_CONTROL_2 & (~_BIT3));
    // DDC1
    MCU_FF2E_DDC1_DDC_CONTROL_2 = (usISPChannel & _BIT2) ? (MCU_FF2E_DDC1_DDC_CONTROL_2 | _BIT3) : (MCU_FF2E_DDC1_DDC_CONTROL_2 & (~_BIT3));
    // DDC2
    MCU_FE66_DDC2_DDC_CONTROL_2 = (usISPChannel & _BIT3) ? (MCU_FE66_DDC2_DDC_CONTROL_2 | _BIT3) : (MCU_FE66_DDC2_DDC_CONTROL_2 & (~_BIT3));
    // DDC3
    MCU_FE6F_DDC3_DDC_CONTROL_2 = (usISPChannel & _BIT4) ? (MCU_FE6F_DDC3_DDC_CONTROL_2 | _BIT3) : (MCU_FE6F_DDC3_DDC_CONTROL_2 & (~_BIT3));
}
